...
impl ConfigData {
    pub fn from_file(file_path: &str) -> Self {
        ...
        default_config.config.network_configs.extend(data.config.network_configs);
        default_config
    }
    ...
    pub fn default() -> Self {
        ...
        network_configs.insert(String::from("mainnet"), String::from("https://fullnode.mainnet.aptoslabs.com"));
        network_configs.insert(String::from("testnet"), String::from("https://fullnode.testnet.aptoslabs.com"));
        network_configs.insert(String::from("devnet"), String::from("https://fullnode.devnet.aptoslabs.com"));
        Self {
            config: ToolConfig {
